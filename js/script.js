linkmp3.src = audioWeb; audio = new Audio('' + linkmp3.src);
var psn1 = "<b class='alt'>";
var psn2 = "</b><br><br><b id='kalimat_2'>";
var pesanPertama = "" + psn1 + pesanPertamaAtas + psn2 + pesanPertamaBawah + "</b>";
vketik1 = pesanPertama;
var psn3 = "<b class='alt'>"
var psn4 = "<br>";
var pesanKedua = psn3 + pesanKeduaAtas + psn4 + pesanKeduaBawah + "</b>";
kalimat1.innerHTML = pesanKedua;
By.innerHTML = tombol_y;
Bn.innerHTML = tombol_n;
kataditolak.innerHTML = pesantombol_n;
kalimat2ngetikv2.innerHTML = pesantombol_y;
vketik2 = pesanKetiga;
penggantiBy.innerHTML = tombol_y2;
penggantiBn.innerHTML = tombol_n2;
var psnk1 = "<b class='alt'>";
var psnk2 = "<br><br>";
var psnk3 = "</b><br><br>";
...
jumlahKlik = 0;ftganti=0;fungsi=0;ftfungsi=0;fungsiAwal=0;fungsitimer=0;pesanWA = pesanWA.innerHTML;deffotostiker=fotostiker.src;Content.style = "opacity:1;margin-top:30vh;";wallpaper.style="opacity:0";
...
await swalst.fire({title: '' + pesantombol_n, timer: 2000, imageUrl: '' + stikerditolak.src,});
 }
...
async function menuju(){window.location = "https://api.whatsapp.com/send?phone=6282286113835";}
